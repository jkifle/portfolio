  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '40px', animation: 'fadeUp 0.5s ease-out forwards', opacity: 0 }}>
          <StatusBadge label="Open to Networking" />
        </div>

        <h1 className="text-hero" style={{ marginBottom: '12px', animation: 'fadeUp 0.6s 0.1s ease-out forwards', opacity: 0 }}>
          Joseph<br />
        ...
        <div style={{ display: 'flex', gap: '12px', animation: 'fadeUp 0.6s 0.3s ease-out forwards', opacity: 0 }}>
      ...
      <div style={{
        ...
        {/* ── Headshot ────────────────────────────── */}
        <div style={{ width: '100%', maxWidth: '420px', position: 'relative' }} className="flex-shrink-0">
          ...
          <div style={{
            ...
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', letterSpacing: '0.1em', fontWeight: '600' }}>
              Joseph Kifle
            </span>
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', opacity: 0.5, letterSpacing: '0.08em' }}>
              SWE · UTK CS &apos;28
            </span>
          </div>
        </div>
        ...
        {/* ── Code mockup ─────────────────────────── */}
        <div style={{ width: '100%', maxWidth: '420px', border: '1px solid var(--border)', padding: '28px', position: 'relative' }} className="flex-shrink-0">
          <span className="corner-marker tl" />
          <span className="corner-marker tr" />
          <span className="corner-marker bl" />
          <span className="corner-marker br" />
          ...
          <div style={{
            ...
            backgroundColor: 'var(--forest)', marginLeft: '4px',
